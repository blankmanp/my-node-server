...
var _buttonsJs2 = _interopRequireDefault(_buttonsJs);

var NavHeader = (function (_Component) {
    _inherits(NavHeader, _Component);

    _createClass(NavHeader, null, [{
        key: 'propTypes',
        value: {
    ...
    function NavHeader(props) {
        ...
        _get(Object.getPrototypeOf(NavHeader.prototype), 'constructor', this).call(this, props);
    }
    ...
    _createClass(NavHeader, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'nav',
                { className: prefixName + '-table-header clearfix' },
                (function () {
                    if (filter) {
                        return _react2['default'].createElement(_filterJs2['default'], {
                            columns: columns,
                ...
                (function () {
                    if (enableSelection) {
                        return _react2['default'].createElement(_buttonsJs2['default'], {
                            prefixName: prefixName,
                            batch: batch,
                            selected: selected
                        });
