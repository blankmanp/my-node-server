...
var PickerTime = (function (_Component) {
    ...
    function PickerTime() {
        ...
        _get(Object.getPrototypeOf(PickerTime.prototype), 'constructor', this).apply(this, arguments);

        this._handleClick = function (timeType, num) {
            _this.props.timeSwitch(num, timeType);
        };
    }
        ...
        value: function render() {
            if (this.props.dateOnly === true && this.props.timeOnly !== true || this.props.type !== 'day') {
                ...
                return _react2['default'].createElement(
                    'div',
                    { className: 'cat-calendar-cell-footer clearfix' },
                    _react2['default'].createElement(
                        'div',
                        { className: 'cat-calendar-cell cat-calendar-cell-time' },
                        _react2['default'].createElement(
                            'button',
                            {
