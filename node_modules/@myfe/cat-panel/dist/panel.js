    ...
    _createClass(Panel, [{
        ...
        value: function _renderContent() {
            ...
            return _react2['default'].Children.map(this.props.children, function (child) {
                return _react2['default'].cloneElement(child, { prefixName: self.props.prefixName });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var classNames = (0, _catUtil.setClass)(prefixName + '-panel', prefixName + '-panel-' + myStyle, className);
            ...
            return _react2['default'].createElement(
                ...
                footer && _react2['default'].createElement(
                    'div',
                    { className: prefixName + '-panel-footer' },
                    footer
                )
            );
        }
...
Panel.Body = _body2['default'];
Panel.Ul = _ul2['default'];
